var bt = {
    ...
    render_ps: function(item) {
        ...
        html += '<p style="margin-bottom: 19px; margin-top: 11px; color: #FFF"></p>';
        return html;
    },
    ...
    select: function(elem) {
        ...
        function is_show_select_ul(active) {
            if (active) {
                ...
                select_group.css('borderColor', '#2ea9df');
